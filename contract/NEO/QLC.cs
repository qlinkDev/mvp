...
namespace NeoContract2
{
    ...
    {
        //Token Settings
        public static string Name() => "QLC_H_25";
        public static string Symbol() => "QLC";

        // 地址的hash值转成数组，再反序 *********
        //个人地址172, 195, 124, 178, 35, 250, 203, 172, 166, 185, 14, 227, 220, 45, 18, 4, 178, 74, 86, 92
        //public static readonly byte[] Owner = { 47, 60, 170, 33, 216, 40, 148, 2, 242, 150, 9, 84, 154, 50, 237, 160, 97, 90, 55, 183 };
        //public static readonly byte[] Owner = { 172, 195, 124, 178, 35, 250, 203, 172, 166, 185, 14, 227, 220, 45, 18, 4, 178, 74, 86, 92 };
        //反序 92, 86, 74, 178, 4, 18, 45, 220, 227, 14, 185, 166, 172, 203, 250, 35, 178, 124, 195,172
        public static readonly byte[] Owner = { 92, 86, 74, 178, 4, 18, 45, 220, 227, 14, 185, 166, 172, 203, 250, 35, 178, 124, 195, 172 };
        ...
        private const ulong pre_ico_cap = 560000000 * factor; // pre ico token amount
        private const ulong basic_rate = 400 * factor;
        private const int ico_start_time = 1512835200;
        private const int ico_end_time = 1513004400;
        private const ulong max_ico = 300 * basic_rate;
        ...
        public static Object Main(string operation, params object[] args)
        {
            ...
            else if (Runtime.Trigger == TriggerType.Application)
            {
                ...
                if (operation == "icoOver") return IcoOver();
            }
        ...
        // 众筹结束，Owner加上4千万目标未完成的数量
        public static bool IcoOver()
        {
            ...
            if (time > ico_duration)
            {   // 众筹已结束
                // 此方法只能被执行一次，如果满足这个条件表示已执行[totalSupply=total_amount]
                ...
                {
                    BigInteger ico_supply = total_amount - total_supply;  // 未众筹成功的数量
                    BigInteger owner_supply = Storage.Get(Storage.CurrentContext, Owner).AsBigInteger();
                    Storage.Put(Storage.CurrentContext, Owner, owner_supply + ico_supply);
