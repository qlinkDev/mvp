...
public class NeoAPIDateController extends BaseController {
	...
	public @ResponseBody ResponseEntity<JSONObject> saveSsid(@ApiParam(value = "请求入参为JSON格式", required = true) @RequestBody String reqStr, HttpServletRequest request, HttpServletResponse response){
		...
		try {
			...
			logger.info("【saveSsid】接口【发送请求时间】为："+DateUtils.getDate("yyyy-MM-dd HH:mm:ss") + "===请求的参数为：" + params.getJSONObject(0).toString());
			JSONObject json = neoService.saveSsi(params.getJSONObject(0));
			logger.info("【saveSsid】接口【完成请求时间】为："+DateUtils.getDate("yyyy-MM-dd HH:mm:ss") + "===请求返回结果为：" + json.toString());
			logger.info("【saveSsid】接口【总耗时】======="+(System.currentTimeMillis() - currentTime1)/1000 +"秒");
		...
		logger.info("【saveSsid】接口【完成请求时间】为："+DateUtils.getDate("yyyy-MM-dd HH:mm:ss") + "===请求返回结果为：" + res.toString());
	...
	public @ResponseBody ResponseEntity<JSONObject> querySsid(@ApiParam(value = "请求入参为JSON格式", required = true) @RequestBody String reqStr, HttpServletRequest request, HttpServletResponse response){
		...
		try {
			...
			logger.info("【querySsid】 接口【发送请求时间】为："+DateUtils.getDate("yyyy-MM-dd HH:mm:ss") + "===请求的参数为：" + params.getJSONObject(0).toString());
			JSONObject json =neoService.queryBySsid(params.getJSONObject(0));
			logger.info(" 【querySsid】接口【完成请求时间】为："+DateUtils.getDate("yyyy-MM-dd HH:mm:ss") + "===请求返回结果为：" + json.toString());
			return new ResponseEntity(json,HttpStatus.OK);
		}catch (Exception e) {
		...
		logger.info("【querySsid】接口【完成请求时间】为："+DateUtils.getDate("yyyy-MM-dd HH:mm:ss") + "===请求返回结果为：" + res.toString());
		return new ResponseEntity(res, HttpStatus.OK);
	}
	...
	public @ResponseBody ResponseEntity<JSONObject> saveRecord(@ApiParam(value = "请求入参为JSON格式", required = true) @RequestBody String reqStr, HttpServletRequest request, HttpServletResponse response){
		...
		try {
			...
			long currentTime1 = System.currentTimeMillis();
			logger.info("【saveRecord】接口【发送请求时间】为："+DateUtils.getDate("yyyy-MM-dd HH:mm:ss") + "===请求的参数为：" + params.getJSONObject(0).toString());
			JSONObject json = neoService.saveRecord(params.getJSONObject(0));
			logger.info("【saveRecord】接口【完成请求时间】为："+DateUtils.getDate("yyyy-MM-dd HH:mm:ss") + "===请求返回结果为：" + json.toString());
			logger.info("【saveRecord】接口【总耗时】======="+(System.currentTimeMillis() - currentTime1)/1000 +"秒");
			return new ResponseEntity(json, HttpStatus.OK);
		} catch (Exception e) {
		...
		logger.info("【saveRecord】接口【发送请求时间】为："+DateUtils.getDate("yyyy-MM-dd HH:mm:ss") + "===请求返回结果为：" + res.toString());
		return new ResponseEntity(res, HttpStatus.OK);
	}
	...
	public @ResponseBody ResponseEntity<JSONObject> queryRecord(@ApiParam(value = "请求入参为JSON格式", required = true) @RequestBody String reqStr, HttpServletRequest request, HttpServletResponse response){
		...
		try {
			...
			logger.info("【queryRecord】接口【发送请求时间】为："+DateUtils.getDate("yyyy-MM-dd HH:mm:ss") + "===请求的参数为：" + params.getJSONObject(0).toString());
			JSONObject json =neoService.queryByRid(params.getJSONObject(0));
			logger.info(" 【queryRecord】接口【完成请求时间】为："+DateUtils.getDate("yyyy-MM-dd HH:mm:ss") + "===请求返回结果为：" + json.toString());
			return new ResponseEntity(json,HttpStatus.OK);
		} catch (Exception e) {
		...
		logger.info("【queryRecord】接口【发送请求时间】为："+DateUtils.getDate("yyyy-MM-dd HH:mm:ss") + "===请求返回结果为：" + res.toString());
		return new ResponseEntity(res, HttpStatus.OK);
	}
